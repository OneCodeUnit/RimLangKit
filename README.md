...
Обратите внимание, что программа добавит немного больше объектов, чем требуется. Не стесняйтесь удалять лишнее.

Поскольку у каждого мода файлы склонений должны быть свои, то в составных переводах (где есть "loadFolders.xml") в качестве корневой папки стоит выбирать папку составной части (ту, в которой лежит "Languages").
