...
Проведено три этапа рефакторинга проекта для улучшения производительности, надежности и поддерживаемости кода.
...
## Следующие этапы рефакторинга (Фаза 4)
...
4. ⏳ Переписать CaseCreatorButton и PreTranslatorButton на async/await

### Приоритет 2:
5. ⏳ Рефакторить TagCollector (удалить статические коллекции)
6. ⏳ Добавить real-time валидацию путей в TextBox
7. ⏳ Разделить MainForm по паттерну MVP/MVVM
8. ⏳ Создать интерфейс ITranslationRepository

### Приоритет 3:
9. ✅ ~~Заменить магические числа на константы~~ — выполнено в Фазе 3
10. ✅ ~~Убрать дублирование кода~~ — выполнено в Фазе 3
11. ✅ ~~Валидация путей для безопасности~~ — выполнено в Фазе 3
12. ⏳ Добавить unit-тесты для сервисов
13. ⏳ Заменить магические строки в других модулях (Processors/, Checks/, Modules/)
